...
parser = argparse.ArgumentParser(
    description="""
        Read in a batch of0 .emd files via hyperspy module, add a salebar and save the figure of image and overlaid scalebar as .png
    """
)

parser.add_argument("emd_dir_str", help="The path of the .emd file")
...
emd_dir_p = Path(args.emd_dir_str)
...
for emd_file_p in emd_dir_p.glob("*.emd"):
